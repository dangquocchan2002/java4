	...
	<div class="container-fluid">
		<main class="tm-main">
			...
			<div class="row tm-row tm-mb-120">
				<div class="col-12">
					<h2 class="tm-color-primary tm-post-title tm-mb-60">Quên mật khẩu</h2>
					<div class="col">
				...
				<div class="col-lg-8 tm-contact-left">
					<form action="/ChandqPD05208_ASM/ForgotPassword" method="post"
						...
						<div class="form-group row mb-4">
							<label 
								...
								name</label>
							<div class="col-sm-9">
								<input class="form-control mr-0 ml-auto" name="id" 
						...
						<div class="form-group row mb-4">
							<label 
								class="col-sm-3 col-form-label text-right tm-color-primary">Email
								</label>
							<div class="col-sm-9">
								<input class="form-control mr-0 ml-auto" name="email" 
									type="text" required placeholder="Nhập Email">
							</div>
						</div>
						...
						<div class="form-group row text-right">
							<div class="col-12">
								<button class="tm-btn tm-btn-primary tm-btn-small" type="submit">Send
									</button>
							</div>
