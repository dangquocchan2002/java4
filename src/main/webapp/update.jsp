    ...
    <div class="container-fluid">
        <main class="tm-main">
            ...
            <div class="row tm-row tm-mb-120">
                <div class="col-12">
                    <h2 class="tm-color-primary tm-post-title tm-mb-60">Cập nhật</h2>
                    <div class="col">
                ...
                <div class="col-lg-8 tm-contact-left">
                    ...
                    class="mb-5 ml-auto mr-0 tm-contact-form">   
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control mr-0 ml-auto" name="id" value="${user.id}"  type="text" required placeholder="Nhập ID">                            
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
    						...
    						<div class="col-sm-9">
    						<input class="form-control mr-0 ml-auto" type="password" value="${user.password}" required placeholder="Password" name="password" />
    						</div>
    					</div>
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control mr-0 ml-auto" name="fullname" value="${user.fullname}" type="text" required placeholder="Fullname">                            
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="email" class="col-sm-3 col-form-label text-right tm-color-primary">Email</label>
                            <div class="col-sm-9">
                                <input class="form-control mr-0 ml-auto" name="email" value="${user.email}" type="email" required required placeholder="Email">                            
                            </div>
                        </div>
                        ...
                        <div class="form-group row text-right">
                            <div class="col-12">
                                <button class="tm-btn tm-btn-primary tm-btn-small" formaction="/ChandqPD05208_ASM/edit-profile">Cập nhật</button>                        
                            </div> 
