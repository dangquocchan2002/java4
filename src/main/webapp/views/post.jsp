            ...
            <div class="row tm-row">
                <div class="col-12">
                    ...
                    <video width="954" height="535" controls class="tm-mb-40">
                        <source src="/ChandqPD05208_ASM/video/Rosie.mp4" type="video/mp4">							  
            ...
            <div class="row tm-row">
                <div class="col-lg-8 tm-post-col">
                    <div class="tm-post-full">                    
                        <div class="mb-4">
                            <h2 class="pt-2 tm-color-primary tm-post-title">Tiêu đề Video</h2>
                            <p class="tm-mb-40">Ngày đăng</p>
                            <p>
                                Nội dung video </p>
                            <p>
                        ...
                        <div>
                            ...
                            <div class="tm-comment tm-mb-45">
                                <figure class="tm-comment-figure">
                                    <img src="/ChandqPD05208_ASM/img/comment-1.jpg" alt="Image" class="mb-2 rounded-circle img-thumbnail">
                                    <figcaption class="tm-color-primary text-center">Sơn IT</figcaption>
                                </figure>
                                <div>
                                    <p>
                                        Video hay và thú vị quá, mình rất thoải mái khi xem video này!
                                    </p>
                                    <div class="d-flex justify-content-between">
                                        <a href="#" class="tm-color-primary">Trả lời</a>
                            ...
                            <div class="tm-comment-reply tm-mb-45">
                                ...
                                <div class="tm-comment">
                                    <figure class="tm-comment-figure">
                                        <img src="/ChandqPD05208_ASM/img/comment-2.jpg" alt="Image" class="mb-2 rounded-circle img-thumbnail">
                                        <figcaption class="tm-color-primary text-center">Hoàng Lê Duy</figcaption>    
                                    </figure>
                                    <p>
                                        Video hay và thú vị quá, mình rất thoải mái khi xem video này!
                                    </p>
                            ...
                            <form action="" class="mb-5 tm-comment-form">
                                <h2 class="tm-color-primary tm-post-title mb-4">Bình luận của bạn</h2>
                                <div class="mb-4">
                ...
                <aside class="col-lg-4 tm-aside-col">
                    <div class="tm-post-sidebar">
                        ...
                        <a href="#" class="d-block tm-mb-40">
                            <figure>
                                <img src="/ChandqPD05208_ASM/img/img-02.jpg" alt="Image" class="mb-3 img-fluid">
                                <figcaption class="tm-color-primary">Tiêu đề video</figcaption>
                            </figure>
                        </a>
                        <a href="#" class="d-block tm-mb-40">
                            <figure>
                                <img src="/ChandqPD05208_ASM/img/img-05.jpg" alt="Image" class="mb-3 img-fluid">
                                <figcaption class="tm-color-primary">Tiêu đề video</figcaption>
                            </figure>
                        </a>
                        <a href="#" class="d-block tm-mb-40">
                            <figure>
                                <img src="/ChandqPD05208_ASM/img/img-06.jpg" alt="Image" class="mb-3 img-fluid">
                                <figcaption class="tm-color-primary">Tiêu đề video</figcaption>
                            </figure>
                        </a>
                    </div>                    
