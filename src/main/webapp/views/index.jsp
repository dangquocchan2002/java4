                ...
                <article class="col-12 col-md-6 tm-post">
                    ...
                    <a href="post.jsp" class="effect-lily tm-post-link tm-pt-60">
                        <div class="tm-post-link-inner">
                            <img src="/ChandqPD05208_ASM/img/img-01.jpg" alt="Image" class="img-fluid">
                        ...
                        <h2 class="tm-pt-30 tm-color-primary tm-post-title">Nội dung Video</h2>
                    </a>
                    <p class="tm-pt-30">
                        <!-- mô tả  -->
                    </p>
                    <div class="d-flex justify-content-between tm-pt-45">
                        <span class="tm-color-primary">Du lịch </span>
                        <span class="tm-color-primary">June 24, 2020</span>
                    </div>
                    <hr>
                    <div class="d-flex justify-content-between">
                        <span>36 bình luận</span>
                        <span>đăng bởi SơnIT</span>
                    </div>
                </article>
                <article class="col-12 col-md-6 tm-post">
                    <hr class="tm-hr-primary">
